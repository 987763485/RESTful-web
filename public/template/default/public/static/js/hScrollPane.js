    ...
    $.fn.hScrollPane = function (settings) {
        ...
        this.each(function () {
            var container = $(this),
				...
				dragbar = (container.find(".hScrollPane_dragbar").length == 0 && c > w) ? container.append('<div class="hScrollPane_dragbar"><div class="hScrollPane_draghandle"><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td width="6" style="background:url(/public/template/default/public/static/js/images/pressbar_left.gif) no-repeat left top; width:6px">&nbsp;</td><td style="background:url(/public/template/default/public/static/js/images/pressbar_1.jpg) repeat-x left top">&nbsp;</td><td width="6" style="background:url(/public/template/default/public/static/js/images/pressbar_right.gif) no-repeat right top; width:6px" height="11">&nbsp;</td></tr></table></div></div>').find(".hScrollPane_dragbar") : container.find(".hScrollPane_dragbar"), //避免多次初始化时的重复append;
